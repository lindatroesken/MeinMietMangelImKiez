...
COPY ["backend/target/backend-0.0.1-SNAPSHOT.jar", "/service/mietmangelmanager.jar"]
...
#
CMD ["java", "-XX:MaxMetaspaceSize=128m", "-Xmx384m", "-Xms384m", "-Xmn128m", "-jar", "/service/mietmangelmanager.jar"]
